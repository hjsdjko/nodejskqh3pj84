...
<div class="home-preview" :style='{"width":"100%","margin":"0 auto","flexDirection":"column","background":"#f6f6f6","display":"flex"}'>
	...
	<div id="animate_newsnews" class="news animate__animated" :style='{"width":"100%","padding":"50px 10%","margin":"0 auto","position":"relative","background":"#00aa3a","order":"2"}'>
		...
		<div class="title" :style='{"margin":"0 0 42px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231108/790b0679cc8e4697ae015e18030d9c73.png) no-repeat left center","width":"auto","fontSize":"#000000","minWidth":"252px","height":"128px"}'>
			<span :style='{"fontSize":"43px","lineHeight":"180px","color":"#fff","fontWeight":"600"}'>资讯信息</span>
		</div>
...
<!-- 商品推荐 -->
<div id="animate_recommendremenjingdian" class="recommend animate__animated" :style='{"width":"80%","padding":"40px 0","margin":"0 auto","position":"relative","order":"1"}'>
    ...
    <div class="title" :style='{"margin":"10px auto 20px","color":"#000000","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231108/785b92a18bec459faffc7c29ddd93c9d.png) no-repeat left center","width":"auto","minWidth":"252px","height":"128px"}'>
		<span :style='{"fontSize":"43px","lineHeight":"180px","color":"#000000","fontWeight":"600"}'>热门景点推荐</span>
	</div>
	...
	<div v-if="remenjingdianRecommend.length" class="list list12 index-pv1 list12remenjingdian" :style='{"width":"100%","padding":"10px","background":"none","height":"auto"}'>
	  <div class="list" :style='{"margin":"40px 0 0","overflow":"hidden","flexWrap":"wrap","background":"none","display":"flex","justifyContent":"space-between","height":"auto"}'>
	    <div :style='{"cursor":"pointer","width":"49%","margin":"0 0 30px","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in remenjingdianRecommend" :key="index" @click="toDetail('remenjingdianDetail', item)">
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","display":"block","height":"288px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","display":"block","height":"288px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"0 10px","color":"#333","textAlign":"center","background":"#fff","width":"100%","lineHeight":"60px","fontSize":"16px"}'>{{item.jingdianmingcheng}}</div>
			<div class="line1" :style='{"padding":"0 10px","color":"#333","textAlign":"center","background":"#fff","width":"100%","lineHeight":"60px","fontSize":"16px"}'>{{item.dengji}}</div>
			<div class="line1" :style='{"padding":"0 10px","color":"#333","textAlign":"center","background":"#fff","width":"100%","lineHeight":"60px","fontSize":"16px"}'>{{item.chengshifenlei}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('remenjingdian')" :style='{"border":"2px solid #000000","cursor":"pointer","padding":"16px 60px","whiteSpace":"nowrap","top":"90px","textAlign":"center","background":"#fff","display":"block","lineHeight":"1em","position":"absolute","right":"0"}'>
...
<!-- 特价商品 -->
<div id="animate_listremenjingdian" class="lists animate__animated" :style='{"width":"100%","padding":"40px 10%","margin":"0 auto","position":"relative","background":"#fff","order":"3"}'>
	...
	<div class="title" :style='{"margin":"0 0 40px","minWidth":"252px","background":"url(http://codegen.caihongy.cn/20231108/785b92a18bec459faffc7c29ddd93c9d.png) no-repeat left center","height":"128px"}'>
	  <span :style='{"fontSize":"43px","lineHeight":"180px","color":"#000000","fontWeight":"600"}'>热门景点展示</span>
	</div>
	...
	<div v-if="remenjingdianList.length" class="list list13 index-pv1" :style='{"width":"100%","background":"none","height":"auto"}'>
	  <div :style='{"width":"100%","padding":"12px 0px","justifyContent":"center","display":"flex","height":"auto"}' class="top">
		<template v-for="item,index in remenjingdianList">
		<template v-if="index < 5">
		<img @click="toDetail('remenjingdianDetail', item)" :name="item.id" :style='{"cursor":"pointer","width":"18%","margin":"0 1%","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		<img @click="toDetail('remenjingdianDetail', item)" :name="item.id" :style='{"cursor":"pointer","width":"18%","margin":"0 1%","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
		</template>
		</template>
	  </div>
	  <div v-if="remenjingdianList.length > 5" :style='{"width":"100%","padding":"12px 0px","justifyContent":"center","display":"flex","height":"auto"}' class="center">
		<template v-for="item,index in remenjingdianList">
	  ...
	  <div v-if="remenjingdianList.length > 8" :style='{"width":"100%","padding":"12px 0px","justifyContent":"center","display":"flex","height":"auto"}' class="bottom">
		<template v-for="item,index in remenjingdianList">
	...
	<div @click="moreBtn('remenjingdian')" :style='{"border":"2px solid #000","cursor":"pointer","padding":"16px 60px","margin":"40px auto","top":"40px","textAlign":"center","background":"none","display":"block","width":"auto","position":"absolute","right":"10%"}'>
		<span :style='{"color":"#000000","fontSize":"16px","fontWeight":"600"}'>查看更多</span>
		<i :style='{}' class="icon iconfont "></i>
	</div>
...
<!-- 特价商品 -->
<div id="animate_listjiudianxinxi" class="lists animate__animated" :style='{"width":"100%","padding":"40px 10%","margin":"0 auto","position":"relative","background":"#fff","order":"3"}'>
	<div v-if="false" class="idea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
	...
	<div class="title" :style='{"margin":"0 0 40px","minWidth":"252px","background":"url(http://codegen.caihongy.cn/20231108/785b92a18bec459faffc7c29ddd93c9d.png) no-repeat left center","height":"128px"}'>
	  <span :style='{"fontSize":"43px","lineHeight":"180px","color":"#000000","fontWeight":"600"}'>酒店信息展示</span>
	</div>
	...
	<div v-if="jiudianxinxiList.length" class="list list13 index-pv1" :style='{"width":"100%","background":"none","height":"auto"}'>
	  <div :style='{"width":"100%","padding":"12px 0px","justifyContent":"center","display":"flex","height":"auto"}' class="top">
		<template v-for="item,index in jiudianxinxiList">
		<template v-if="index < 5">
		<img @click="toDetail('jiudianxinxiDetail', item)" :name="item.id" :style='{"cursor":"pointer","width":"18%","margin":"0 1%","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.jiudiantupian)" :src="item.jiudiantupian.split(',')[0]" alt="" />
		<img @click="toDetail('jiudianxinxiDetail', item)" :name="item.id" :style='{"cursor":"pointer","width":"18%","margin":"0 1%","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.jiudiantupian?item.jiudiantupian.split(',')[0]:'')" alt="" />
		</template>
		</template>
	  </div>
	  <div v-if="jiudianxinxiList.length > 5" :style='{"width":"100%","padding":"12px 0px","justifyContent":"center","display":"flex","height":"auto"}' class="center">
		<template v-for="item,index in jiudianxinxiList">
		<template v-if="index > 4 && index < 8">
		<img @click="toDetail('jiudianxinxiDetail', item)" :name="item.id" :style='{"cursor":"pointer","width":"18%","margin":"0 1%","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.jiudiantupian)" :src="item.jiudiantupian.split(',')[0]" alt="" />
		<img @click="toDetail('jiudianxinxiDetail', item)" :name="item.id" :style='{"cursor":"pointer","width":"18%","margin":"0 1%","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.jiudiantupian?item.jiudiantupian.split(',')[0]:'')" alt="" />
	  ...
	  <div v-if="jiudianxinxiList.length > 8" :style='{"width":"100%","padding":"12px 0px","justifyContent":"center","display":"flex","height":"auto"}' class="bottom">
		<template v-for="item,index in jiudianxinxiList">
		<template v-if="index == 8">
		<img @click="toDetail('jiudianxinxiDetail', item)" :name="item.id" :style='{"cursor":"pointer","width":"18%","margin":"0 1%","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.jiudiantupian)" :src="item.jiudiantupian.split(',')[0]" alt="" />
		<img @click="toDetail('jiudianxinxiDetail', item)" :name="item.id" :style='{"cursor":"pointer","width":"18%","margin":"0 1%","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.jiudiantupian?item.jiudiantupian.split(',')[0]:'')" alt="" />
	...
	<div @click="moreBtn('jiudianxinxi')" :style='{"border":"2px solid #000","cursor":"pointer","padding":"16px 60px","margin":"40px auto","top":"40px","textAlign":"center","background":"none","display":"block","width":"auto","position":"absolute","right":"10%"}'>
		<span :style='{"color":"#000000","fontSize":"16px","fontWeight":"600"}'>查看更多</span>
		<i :style='{}' class="icon iconfont "></i>
	</div>
  ...
  export default {
    ...
    data() {
      return {
		...
		newsIndex15: 0,
		newsCategoryList15: [],
		recommendIndex12remenjingdian: 0,
		recommendList12remenjingdian: [],
		recommendColumn12remenjingdian: '',
    ...
    created() {
		...
		this.getList();
		this.remenjingdianRecommendCate()
    },
	mounted() {
    ...
    methods: {
		...
		remenjingdianRecommendCate(){
			this.$http.get('chengshifenlei/list',{}).then(res => {
			  if (res.data.code == 0) {
				this.recommendList12remenjingdian = res.data.data.list
			  }
			});
			this.recommendColumn12remenjingdian = 'chengshifenlei'
		},
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendremenjingdian',css:'animate__zoomIn'},
				{id:'animate_listremenjingdian',css:'animate__zoomIn'},
				{id:'animate_listjiudianxinxi',css:'animate__zoomIn'},
      ...
      getSystemIntroduction() {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "remenjingdian/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "remenjingdian/autoSort2";
          }
			data = {
				page: 1,
				limit: 4,
			}
			if(this.recommendIndex12remenjingdian != 0){
				data.chengshifenlei = this.recommendList12remenjingdian[this.recommendIndex12remenjingdian - 1].chengshifenlei
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.remenjingdianRecommend = res.data.data.list;
			...
			this.$http.get('remenjingdian/list', {params: data}).then(res => {
				if (res.data.code == 0) {
					this.remenjingdianList = res.data.data.list;
