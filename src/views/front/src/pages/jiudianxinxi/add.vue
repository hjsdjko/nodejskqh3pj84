...
<div :style='{"width":"100%","padding":"20px 10%","margin":"30px auto","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","float":"left","display":"inline-block"}'  label="类别" prop="leibie">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","float":"left","display":"inline-block"}'  label="星级" prop="xingji">
            <el-select v-model="ruleForm.xingji" placeholder="请选择星级" :disabled=" false  ||ro.xingji" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","float":"left","display":"inline-block"}' label="酒店地址" prop="jiudiandizhi">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","float":"left","display":"inline-block"}' label="酒店介绍" prop="jiudianjieshao">
            <editor 
