	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.luxiantupian" label="路线图片" prop="luxiantupian">
					<file-upload
						tip="点击上传路线图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.luxiantupian" label="路线图片" prop="luxiantupian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="交通方式" prop="jiaotongfangshi">
					<el-select :disabled="ro.jiaotongfangshi" v-model="ruleForm.jiaotongfangshi" placeholder="请选择交通方式" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="出行时间" prop="chuxingshijian">
					<el-select :disabled="ro.chuxingshijian" v-model="ruleForm.chuxingshijian" placeholder="请选择出行时间" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="出行时间" prop="chuxingshijian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="途径路段" prop="tujingluduan">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.tujingluduan" label="途径路段" prop="tujingluduan">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.tujingluduan}}</span>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.luxianxiangqing = this.ruleForm.luxianxiangqing.replace(reg,'../../../nodejskqh3pj84/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
