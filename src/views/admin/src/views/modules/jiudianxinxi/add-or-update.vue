	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="类别" prop="leibie">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="类别" prop="leibie">
					<el-input v-model="ruleForm.leibie"
						placeholder="类别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="星级" prop="xingji">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="星级" prop="xingji">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="酒店介绍" prop="jiudianjieshao">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jiudianjieshao" label="酒店介绍" prop="jiudianjieshao">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiudianjieshao = this.ruleForm.jiudianjieshao.replace(reg,'../../../nodejskqh3pj84/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
